...
},{"./lib/Crypto":2}],2:[function(require,module,exports){
...
var _cryptojs = require("cryptojs");

function privKeyGen() {
  var privKey = _cryptojs.CryptoJS.util.randomBytes(32);

  var privKeyHex = _cryptojs.CryptoJS.util.bytesToHex(privKey);
