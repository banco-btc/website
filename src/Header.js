      ...
      <Navbar bg="light" className="border-bottom" expand="md">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            <NavDropdown.Item href="/single_wallet">Single Wallet <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
